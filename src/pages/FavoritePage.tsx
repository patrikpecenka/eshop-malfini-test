    ...
    <>
      ...
      >
        <Paper
          ...
          mt={20}
        >
          <Tabs variant="outline" radius="sm" defaultValue="all" value={activeTab} onChange={setActiveTab}>
            <Tabs.List>
              <Tabs.Tab value="all">All</Tabs.Tab>
              <Tabs.Tab value="jewelery" leftSection={<IconDiamond size={18} />}>Jewelery</Tabs.Tab>
              <Tabs.Tab value="electronics" leftSection={<IconDeviceLaptop size={18} />}>Electronics</Tabs.Tab>
              <Tabs.Tab value="men's clothing" leftSection={<IconShirt size={18} />}>Men's clothing</Tabs.Tab>
              <Tabs.Tab value="women's clothing" leftSection={<IconShirt size={18} />}>Women's clothing</Tabs.Tab>
            </Tabs.List>
          </Tabs>
          <Title
            m={10}
